...
See the ``web3.eth`` API for the full list of :ref:`available methods <web3.eth>`.


Sending transactions
~~~~~~~~~~~~~~~~~~~~

Broadly, there are three categories of transactions:
- transferring ether from an account you control, 
- deploying new smart contracts, and
